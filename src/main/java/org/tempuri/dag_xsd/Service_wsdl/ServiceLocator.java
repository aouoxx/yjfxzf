...
/**
 * gSOAP 2.8.6 generated service definition
 */
    ...
    public org.tempuri.dag_xsd.Service_wsdl.ServicePortType getService() throws javax.xml.rpc.ServiceException {
    ...
    public org.tempuri.dag_xsd.Service_wsdl.ServicePortType getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.dag_xsd.Service_wsdl.ServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tempuri.org/dag.xsd/Service.wsdl", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://tempuri.org/dag.xsd/Service.wsdl", "Service"));
        }
